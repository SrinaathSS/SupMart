        ...
        <ul>
          {isAdminLoggedIn && (
            <>
              ...
              <li><Link to="/pos"><span className="icon">💳</span><span className="text">POS</span></Link></li>
              ...
              <li><Link to="/inventory-management"><span className="icon">🗃️</span><span className="text">Inventory Management</span></Link></li>
              <li><Link to="/customer-management"><span className="icon">👥</span><span className="text">Customer Management</span></Link></li>
